  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        <Grid container spacing={5} textAlign={{ xs: 'center', md: 'left' }}>
        ...
        >
          ...
          <Box>
            <Link component={RouterLink} to="/terms-of-use" color="inherit" sx={{ ml: { xs: 0, sm: 3 }, mt: { xs: 1, sm: 0 }, display: 'block' }}>
              Terms of Use
            </Link>
            <Link component={RouterLink} to="/privacy-policy" color="inherit" sx={{ ml: { xs: 0, sm: 3 }, mt: { xs: 1, sm: 0 }, display: 'block' }}>
              Privacy Policy
            </Link>
          </Box>
        </Box>
